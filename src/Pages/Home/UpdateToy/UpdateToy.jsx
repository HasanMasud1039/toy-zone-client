                ...
                <form onSubmit={handleUpdateToy}>
                    <div className="card-body">
                        ...
                        <div className="form-control">
                            ...
                            <input type="text" defaultValue={sellerName} placeholder="Seller Name" name='seller_name' className="input input-bordered" />
                        </div>
                        <div className="form-control">
                            <label className="label">
                                <span className="label-text">Seller Email</span>
                            </label>
                            <input type="email" defaultValue={sellerEmail} placeholder="Seller Email" name='seller_email' className="input input-bordered" />
                        </div>
                        <div className="form-control">
                            <label className="label">
