...
const TabToy = ({ categoryToy}) => {
    ...
    const { picture, name, price, rating, details, subCategory, sellerName, sellerEmail, quantity } = categoryToy;
                    ...
                    <TabPanel  className="border-1 shadow-lg mt-2">
                        <div className="card bg-orange-50 border-2  shadow-xl">
                            ...
                            <div className="card-body items-center text-center">
                                ...
                                <button className="btn btn-error text-white "><Link to={`/alltoys/${categoryToy._id}`}>Details</Link></button>
                                </div>
                            </div>
                        </div>
                    </TabPanel>
